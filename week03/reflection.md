...
I tried to find if this issue is new or if it has been around for a while using bisect but I was not able to find a commit that introduced the issue. It seems like this has been an issue for a while and has not been noticed until now.